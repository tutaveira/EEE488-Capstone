...
lappend arg_list "--component-param=MEM_TINIT_CK=149700"
lappend arg_list "--component-param=MEM_TMRD_CK=3"
...
lappend arg_list "--component-param=SEQ_ROM=SDRAM_Controller_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=SDRAM_Controller_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=SDRAM_Controller_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=SEQUENCER_MEM_SIZE=21504"
...
lappend arg_list "--output-name=SDRAM_Controller_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:SDRAM_Controller_s0.sopcinfo"
lappend arg_list "--report-file=txt:SDRAM_Controller_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "C:/intelfpga_lite/18.1/quartus//sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
